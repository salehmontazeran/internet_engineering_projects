...
from .views import (delete_users_on_gender, employee_create_view,
                    employee_delete_confirmation_view, employee_delete_view,
                    employee_edit_view, employee_list_view,
                    employee_report_view, employee_search_view,
                    get_users_with_name, update_user_salary)
...
urlpatterns = [
    ...
    path(
        "delete/<int:id>/",
        employee_delete_confirmation_view,
        name='employee_delete'
    ),
    path("edit/<int:id>/", employee_edit_view, name='employee_edit'),
    path("delete/", employee_delete_view),
